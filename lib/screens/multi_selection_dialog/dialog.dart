        ...
        child: Material(
          ...
          child: SlideTransition(
            ...
            child: Container(
              ...
              child:
                  Column(mainAxisAlignment: MainAxisAlignment.end, mainAxisSize: MainAxisSize.min, children: <Widget>[
                Container(
                  decoration: ShapeDecoration(
                      color: dialogColor, shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(14.0))),
                  child: ListView.separated(
                    physics: const NeverScrollableScrollPhysics(),
                    shrinkWrap: true,
                    itemCount:
                        widget.dialogContent.where((element) => element.dialogItemType == DialogItemType.item).length,
                    itemBuilder: (context, index) => DialogItem(
                      dialogItemContent: widget.dialogContent
                          .where((element) => element.dialogItemType == DialogItemType.item)
                          .elementAt(index),
                    ),
