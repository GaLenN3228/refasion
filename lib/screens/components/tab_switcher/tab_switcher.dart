...
class _TabSwitcherState extends State<TabSwitcher> {
  ...
  // Function() codeAuthorizationListener;
        ...
        (newSharedPreferences) {
          if (!newSharedPreferences.containsKey(Prefs.need_show_authorization_screen)) {
            Navigator.of(context)
                .push(MaterialPageRoute(builder: (context) => PhonePage(fromStart: true)));
  ...
  openDeliveryTypesSelector(
    ...
    if (!await BaseRepository.isAuthorized()) {
      // if (codeAuthorizationListener == null) {
      //   codeAuthorizationListener = () {
      //     print("codeAuthorizationListener");

      //     return openDeliveryTypesSelector(
      //       context,
      //       id,
      ...
      //     );
      //   };
      //   codeAuthorizationRepository.addListener(codeAuthorizationListener);
      // }
      ...
      // codeAuthorizationRepository.removeListener(codeAuthorizationListener);
      // codeAuthorizationListener = null;
  ...
  void dispose() {
    ...
    // codeAuthorizationRepository?.dispose();
